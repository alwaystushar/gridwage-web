          ...
          <div className="col-span-12 lg:col-span-7 relative mt-[8vw] lg:mt-0">
            ...
            >
              ...
              >
                {/* Avatar 1 */}
                <div 
                  className="avatar-card bg-white/95 backdrop-blur-sm rounded-full pl-[2.5vw] pr-[3vw] py-[1.8vw] md:pl-[1vw] md:pr-[1.2vw] md:py-[0.55vw] flex items-center gap-[2vw] md:gap-[0.7vw] shadow-lg" 
                  style={{ opacity: 0 }}
                >
                  <img
