        ...
        <div className="grid md:px-[6vw] grid-cols-12 gap-[6vw] md:gap-[4vw] items-stretch overflow-x-hidden">
          ...
          <div className="col-span-12 md:col-span-6 flex flex-col justify-center md:mt-0 mt-[8vw] max-sm:px-[4vw] overflow-x-hidden">
            ...
            <div className="mt-[8vw] md:mt-[2.5vw]">
              <MagneticButton
                variant="outline"
                className="border-white text-white hover:text-[var(--brand-500)] hover:bg-white px-[7.2vw] md:px-[4vw] py-[1.98vw] md:py-[1.1vw] rounded-[9vw] md:rounded-[5vw]"
              >
                Get Started
              </MagneticButton>
            </div>
            ...
            {/* Counters */}
            <div className="mt-[12vw] md:mt-[4vw] md:grid flex grid-cols-12 gap-[8vw] md:gap-[4vw] text-left">
              <div className="col-span-12 md:col-span-4">
                <TextReveal
                  className="font-medium h3"
                  lineHeight="1.1"
                >
